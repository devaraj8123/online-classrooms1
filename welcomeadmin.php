...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			...
			<a href="qureydetails"><button href="" type="submit" class="btn btn-primary">QUERY</button></a>
			<a href="readas"><button href="" type="submit" class="btn btn-primary">Check Assignement</button></a>
