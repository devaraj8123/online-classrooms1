...
<div class="container">
	<div class="row">
		<div class="col-md-8">
			...
			<a href="Exam.php"><button href="" type="submit" class="btn btn-primary">Result</button></a>
			...
			<a href="readas.php"><button href="" type="submit" class="btn btn-primary">Check Assignement</button></a>
