...
<div class="container" style="max-width: 1200px;">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The “NIMS CLASSROOM” Website (web based application) is useful for the
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">NIMS CLASSROOM</h2>
		</div>
		<div class="col-md-6">
		...
		<div class="col-md-6">
			<img class="img-responsive" src="images/Screenshot_7-5-2025_145411_photos.google.com.jpeg" alt="">
		</div>
	</div>
